...
public class HomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        DBUtils.hoverButton(button_nextMonth, "-fx-background-color: #fda35a;");
        DBUtils.hoverButton(button_preMonth, "-fx-background-color: #fda35a;");

        label_welcome.setText("Welcome " + DBUtils.loggedInUser + "!");


        button_books.setOnAction(event -> DBUtils.changeScene(event, "/com/book/bookInfo.fxml", "Book Info", null, null, null));

        //button_books.setOnAction(event -> DBUtils.changeScene(event, "/com/API/APIbook.fxml", "Book Info", null, null, null));
        //button_books.setOnAction(event -> DBUtils.changeScene(event, "/com/API/APIbookInfo.fxml", "Book Info", null, null, null));
