...
public class AccountController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ChangePassController.MenuHovering(button_home, button_issuedBooks, button_books, button_transactions, button_student, button_changePassword, button_signOut, button_delAccount, button_edit);
        DBUtils.hoverButton(button_save, "-fx-background-color: #eaf36b; -fx-border-color: #eaf36b; -fx-border-width: 3px;");
        DBUtils.hoverButton(button_back, "-fx-background-color: #eaf36b; -fx-border-color: #eaf36b; -fx-border-width: 3px;");

        signOutAcc(button_signOut);
        button_home.setOnAction(event -> DBUtils.changeScene(event, "/com/main-home.fxml", "Library", label_username.getText(), label_email.getText(), label_phone.getText()));
