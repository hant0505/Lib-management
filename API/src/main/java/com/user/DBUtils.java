...
import static com.user.DBTables.DBConnection;
...
public class DBUtils { // helper class contains static method aka actions
    ...
    public static void changeScene(ActionEvent event, String fxmlFile, String title, String username, String email, String phone) {
        ...
        if (username != null && phone != null && email != null) {
            if (fxmlFile.equals("/com/main-home.fxml") || fxmlFile.equals("main-home.fxml")) {
                try {
            ...
            } else if (fxmlFile.equals("account-info.fxml") || fxmlFile.equals("/com/user/account-info.fxml")) {
                try {
                    FXMLLoader loader = new FXMLLoader(DBUtils.class.getResource(fxmlFile));
                    root = loader.load();
    ...
    public static void signUpUser(ActionEvent event, String username, String password, String email, String phone) {
        ...
        try {
            ...
            if (!unique) {
                ...
                changeScene(event, "/com/main-home.fxml", "Library Welcome", username, email, phone);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            ...
            if (!rs.isBeforeFirst()) { // user  not found
                ...
                while (rs.next()) {
                    ...
                    if (retrievedPassword.equals(password)) {
                        ...
                        changeScene(event, "/com/main-home.fxml", "Library Login", username, email, phone);
