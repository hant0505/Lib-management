...
import static Alert.Alert.alertError;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        button_transact.setOnAction(event -> {
            if (currentBook.getQuantity() < 1) {
                alertError("There are no more books available to borrow!");
            } else {
    ...
    private void showBookDetails() {
        if (currentBook != null) {
            ...
            if (currentBook.getImagePath() != null) {
                ...
                coverImage = new Image(getClass().getResource("bia-sach-harry-potter-va-cai-dit-con-me-may.jpg").toExternalForm());
