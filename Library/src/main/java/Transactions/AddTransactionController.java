...
import static Alert.Alert.alertInformation;
        ...
        button_submit.setOnAction(event -> {
            if (!tf_username.getText().isEmpty() && dp_borrowedDate.getValue() != null && cb_quantity.getValue() != null ) {
                ...
                if (quantity <= currentBook.getQuantity()) {
                    ...
                    alertInformation("The book has been successfully borrowed.");
                } else {
                    alertWarning("You are trying to borrow more books than are available !");
                }
            } else {
                alertWarning("Please fill all the fields !");
            }
        });
    ...
    private void showBookDetails() {
        if (currentBook != null) {
            ...
            if (currentBook.getImagePath() != null) {
                ...
                coverImage = new Image(getClass().getResource("/com/Animation/lib/bia-sach-harry-potter-va-cai-dit-con-me-may.jpg").toExternalForm());
            }
